...
El informe está organizado en 10 páginas, donde podemos consultar los resultados del trabajo y comparar los territorios desde distintos puntos de vista.

## Datos

En la carpeta `data/` están los archivos CSV que utiliza Power BI y que proceden de las salidas generadas en los notebooks.
